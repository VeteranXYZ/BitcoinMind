...
export const RABBIT_HOLES: RabbitHole[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: "Bitcoin's Security Model", type: 'text', href: '/texts', time: '45 min' },
      { title: 'Bitcoin Core', type: 'toolkit', href: '/toolkit', time: '2 hrs' },
      { title: 'Mempool.space', type: 'toolkit', href: '/toolkit', time: '1 hr' },
      { title: 'Sparrow Wallet', type: 'toolkit', href: '/toolkit', time: '1 hr' },
    ],
  },
  {
    id: 'rh-custody',
    ...
    steps: [
      ...
      { title: 'BlueWallet for small amounts / watch-only', type: 'toolkit', href: '/toolkit', time: '45 min' },
      ...
      { title: 'Coldcard', type: 'toolkit', href: '/toolkit', time: '2 hrs' },
